...
public static class CronJob
{
    ...
    {
        UsageEventDefinition usageEvent = new()
        {
        ...
        return await httpClient.PostAsJsonAsync(config["NotificationWebHook_URI"], usageEvent).ConfigureAwait(continueOnCapturedContext: false);
    }
