...
module Json =
    ...
    module Marketplace =
        ...
        module MarketplaceSubmissionResult = 
            ...
            let Encoder = encode >> Encode.object
    ...
    let enrich x =
        ...
        |> Extra.withCustom Marketplace.MarketplaceBatchResponseDTO.Encoder Marketplace.MarketplaceBatchResponseDTO.Decoder
