...
type SubmitMeteringAPIUsageEvent = MeteringConfigurationProvider -> MarketplaceBatchRequest -> Task<MarketplaceBatchResponse> 
...
module MeteringConfigurationProvider =
    let create (connections: MeteringConnections) : MeteringConfigurationProvider = // (marketplaceClient: SubmitMeteringAPIUsageEvent) 
